※ 현프로젝트는 배포를 준비 중에 있습니다. 기존 GCP Cloude Run 을 통해 컨테이너 배포 하였으나, 서울 리전의 경우 커스텀 도메인을 지원하지 않는다는 부분을 확인하여, 이에 대한 대안을 찾고 있는 중입니다. 
...
![image](https://github.com/user-attachments/assets/60b579be-7e2f-462b-a6d0-775d66da8809)
